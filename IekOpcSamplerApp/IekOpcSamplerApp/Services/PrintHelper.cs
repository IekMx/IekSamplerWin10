...
{
    public delegate void PrinterMessage(string message, int type);

    public class PrintHelper
    {
        public event PrinterMessage StatusChanged;
        ...
        public virtual void PreparePrintContent(Page page)
        {
            if (firstPage == null)
            {
                ...
                //((PageToPrint)page).ScenarioImage.Source = (RenderTargetBitmap)Parameters["ScenarioImage"];
            }
            // Add the (newly created) page to the print canvas which is part of the visual tree and force it to go
            // through layout so that the linked containers correctly distribute the content inside them.
            if (!PrintCanvas.Children.Contains(firstPage))
            {
        ...
        protected virtual void PrintTaskRequested(PrintManager sender, PrintTaskRequestedEventArgs e)
        {
            ...
            printTask = e.Request.CreatePrintTask("Reporte", sourceRequested =>
            {
        ...
        protected virtual void CreatePrintPreviewPages(object sender, PaginateEventArgs e)
        {
            ...
            printingOptions.Orientation = PrintOrientation.Landscape;
        ...
        protected virtual RichTextBlockOverflow AddOnePrintPreviewPage(RichTextBlockOverflow lastRTBOAdded, PrintPageDescription printPageDescription)
        {
            ...
            RelativePanel printableArea = (RelativePanel)page.FindName("PrintableArea");
            ...
            printableArea.Width = firstPage.Width - 50;
            printableArea.Height = firstPage.Height - 20;
